        ...
        <!-- Sidebar Menu-->
          <ul class="sidebar-menu" id="sidebar-sticky-full">
           ...
           <li><a href="widget.html"><i class="icon-grid"></i><span> Widget</span><span class="label label-warning menu-caption">100+</span></a> </li>
            ...
            <li class="treeview"><a class="waves-effect waves-dark" href="#"><i class="icon-chart"></i><span> Charts &amp; Maps</span><i class="icon-arrow-down"></i>  </a>
                <ul class="treeview-menu">
            ...
            <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icofont icofont-company"></i><span>Menu Level 1</span><i class="icon-arrow-down"></i></a>
              <ul class="treeview-menu">
                <li><a class="waves-effect waves-dark" href="#!"><i class="icon-arrow-right"></i> Level Two</a></li>
                <li class="treeview"><a class="waves-effect waves-dark" href="#!"><i class="icon-arrow-right"></i><span> Level Two</span><i class="icon-arrow-down"></i></a>
                  <ul class="treeview-menu">
                    <li><a class="waves-effect waves-dark" href="#!"><i class="icon-arrow-right"></i> Level Three</a></li>
                    <li><a class="waves-effect waves-dark" href="#!"><i class="icon-arrow-right"></i><span> Level Three</span></a></li>
                  </ul>
                </li>
              </ul>
            </li>
