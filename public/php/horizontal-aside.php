...
<ul class="sidebar-menu">
	...
	<li class="active treeview"><a href="#"><i class="icon-speedometer"></i><span>  Dashboard </span><i class="icon-arrow-down"></i></a>
		<ul class="treeview-menu">
			<li><a href="index.html"><i class="icon-arrow-right"></i><span> Dashboard 1 </span></a>
			</li>
	...
	<li class="treeview"><a href="#"><i class="icon-user-follow"></i><span>  Components  </span><i class="icon-arrow-down"></i></a>
		<ul class="mega-menu">
			<li class="col-md-3">
					...
					<ul class="mega-list row">
						...
						<li class="col-sm-6">
							<ul>
								...
								<li><a class="waves-effect waves-dark" href="menu-bottom.html"><i class="icon-arrow-right"></i> Bottom Menu Fixed</a></li>
	...
	<li class="treeview"><a href="#"><i class="icon-user-follow"></i><span>  Useful Elements  </span><i class="icon-arrow-down"></i></a>
		<ul class="mega-menu">
			<li class="col-md-3">
				<div class="card-block mega-card">
	...
	<li class="treeview"><a href="#"><i class="icon-user-follow"></i><span>  Pages  </span><i class="icon-arrow-down"></i></a>
		<ul class="mega-menu">
			<li class="col-md-3">
				<div class="card-block mega-card">
	...
	<li class="treeview"><a href="#"><i class="icon-present"></i><span> Extras </span><i class="icon-arrow-down"></i></a>
		<ul class="treeview-menu">
			<li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Social </span><i class="icon-arrow-down"></i></a>
				<ul class="treeview-menu">
			...
			<li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Email Template </span><i class="icon-arrow-down"></i></a>
				<ul class="treeview-menu">
					...
					<li><a class="waves-effect waves-dark" href="email-otp.html"><i class="icon-arrow-right"></i> Email OTP</a></li>
					<li><a class="waves-effect waves-dark" href="email-signup.html"><i class="icon-arrow-right"></i> Email Signup</a></li>
				</ul>
			</li>
	...
	<li class="treeview"><a href="#"><i class="icofont icofont-company"></i><span> Menu Level 1 </span><i class="icon-arrow-down"></i></a>
		<ul class="treeview-menu">
			<li><a href="#!"><i class="icon-arrow-right"></i> Level Two</a>
			</li>
			<li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Level Two </span><i class="icon-arrow-down"></i></a>
				<ul class="treeview-menu">
					<li><a href="#!"><i class="icon-arrow-right"></i> Level Three</a>
					</li>
					<li class="treeview"><a href="#"><i class="icon-arrow-right"></i><span>  Level Three </span><i class="icon-arrow-down"></i></a>
						<ul class="treeview-menu">
