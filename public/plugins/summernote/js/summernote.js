    ...
    var h, i = {
        ...
        y = function(b) {
            ...
            this.fontSize = function(b, c) {
                ...
                l(a), c.removeClass("img-rounded rounded-circle img-thumbnail"), b && c.addClass(b), m(a)
        ...
        z = function() {
            this.update = function(b, c) {
                ...
                if (c.image) {
                    ...
                    e('button[data-event="imageShape"][data-value="img-rounded"]', function() {
                    ...
                    }), e('button[data-event="imageShape"][data-value="rounded-circle"]', function() {
                        return f.hasClass("rounded-circle")
                        ...
                        return !f.is(".img-rounded, .rounded-circle, .img-thumbnail")
                    });
                    var g = f.css("float");
